...
// Variables
const rootDomain = "slowchiddy.shop"; // Ganti dengan domain utama kalian
const serviceName = "proxy"; // Ganti dengan nama workers kalian
const apiKey = "oup20nfNTGFiO4gMjkf1D-8oEehXmfGtuDRZo0DW"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "rashidkamote95@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "cab2977b529109cfef7637d7cb2ad298"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "e22cf61c5af71137990c55b93415d4a6"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
